...
ts[module_model_1 == "cs1h-325ms", module_manufacturer_1 := "canadian solar"]
ts[module_model_1 == "spr-225-blk-u", module_manufacturer_1 := "maxeon - sunpower"]
ts[module_model_1 == "spr-e19-320", module_manufacturer_1 := "maxeon - sunpower"]
ts[module_model_1 == "spr-e19-320", module_manufacturer_1 := "maxeon - sunpower"]
ts[module_model_1 == "spr-e19-320", module_manufacturer_1:= "maxeon - sunpower"]
ts[module_model_1 == "spr-x21-345-d-ac", module_manufacturer_1 == "maxeon - sunpower"]
ts[module_model_1 == "spr-a400", module_manufacturer_1 == "maxeon - sunpower"]
ts[module_model_1 == "spr-a400-g-ac", module_manufacturer_1 == "maxeon - sunpower"]
ts[module_model_1 == "d6m310h3a", module_manufacturer_1 := "neo solar power"]
ts[module_model_1 == "lr6-60hpb-310m", module_manufacturer_1 := "longi green energy technology co., ltd."]
ts[module_model_1 == "lr6-60hpb-315m", module_manufacturer_1 := "longi green energy technology co., ltd."]
ts[module_model_1 == "lg305n1c-b3", module_manufacturer_1 := "lg electronics inc."]
ts[module_model_1 == "lg305a1w-b3", module_manufacturer_1 := "lg electronics inc."]
ts[module_model_1 == "lg320n1c-g4", module_manufacturer_1 := "lg electronics inc."]
ts[module_model_1 == "lg335n1c-a5", module_manufacturer_1 := "lg electronics inc."]
ts[module_model_1 == "lg365q1c-a5", module_manufacturer_1 := "lg electronics inc."]
ts[module_model_1 == "lg375a1c-v5", module_manufacturer_1 := "lg electronics inc."]
ts[module_model_1 == "lg360q1c-a5", module_manufacturer_1 := "lg electronics inc."]
ts[module_model_1 == "lg320n1k-a5", module_manufacturer_1 := "lg electronics inc."]
ts[module_model_1 == "sc315b2", module_manufacturer_1 := "tesla"]
ts[module_model_1 == "sc330", module_manufacturer_1 := "tesla"]
ts[module_model_1 == "tsm-335dd06h.05(ii)", module_manufacturer_1 := "trina solar"]
ts[module_model_1 == "tsm-400de15h(ii)", module_manufacturer_1 := "trina solar"]
ts[module_model_1 == "sg310m", module_manufacturer_1 := "peimar"]
ts[module_model_1 == "q.peak duo-g5 325", module_manufacturer_1 := "hanwha qcells"]
ts[module_model_1 == "q.peak duo blk-g5 315", module_manufacturer_1 := "hanwha qcells"]
ts[module_model_1 == "jkm320m-60hbl-q", module_manufacturer_1 := "jinko solar"]
